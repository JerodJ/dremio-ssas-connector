...
@SourceType(value = "SSASARP", label = "SSAS",uiConfig = "ssas-layout.json")
public class SSASConf extends AbstractArpConf<SSASConf> {
  private static final String ARP_FILENAME = "arp/implementation/ssas-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.ssas.SSASDriver";
